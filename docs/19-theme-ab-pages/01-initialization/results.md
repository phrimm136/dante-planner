...
The original plan (`docs/15-theme-ab-pages/01-initialization/instructions.md`) scoped Phase 1 as data pipeline + foundation scaffolding. During implementation, the scope expanded significantly:
