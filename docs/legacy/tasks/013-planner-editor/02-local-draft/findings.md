...
- Testing guidelines in requirements.md (63 manual steps + 57 assertion checkboxes) exceeded typical need but caught edge cases
...
- Separate manual verification steps by phase in requirements.md with shorter per-phase checklists instead of one massive 63-step list
