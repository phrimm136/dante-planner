...
|----------|------------|--------|
| Spec directory | `docs/30-rds-migration` (flat top-level; max existing = 29) | Convention (flat docs layout) |
...
`instructions.md` is the contract (what/why/invariants); `runbook.md` is the execution checklist (how).
...
- `docs/30-rds-migration/runbook.md` — the human execution rulebook.
