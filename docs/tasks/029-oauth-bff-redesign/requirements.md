...
| Spec directory for arg `29` | `docs/tasks/029-oauth-bff-redesign/` — project convention is `docs/NN-slug` (top-level dirs run 00–28); bare `./29` would violate it. | Convention; `docs/` listing |
...
- `docs/tasks/015-auth/` (original auth feature context)
