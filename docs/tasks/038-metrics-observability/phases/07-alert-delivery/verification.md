...
| Delivery path drill-fired once via contact-point test (INV6) — the behavioral proof | Done-When (infra item, phase-07 portion) | **PASS (live, 2026-07-16)** | One policy-routed firing (scratch rule delivery-drill) reached Discord AND Slack — operator-confirmed; rule deleted after | Executed 2026-07-16 via the persisted drill script |
