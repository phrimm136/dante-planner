...
From requirements.md Impact Analysis and architecture-map.md:
...
16. **Create docs/tasks/014-deploy/environment-setup.md**
...
- **After Step 17**: Full Stack Manual Tests
  - Execute all tests from requirements.md "Testing Guidelines"
