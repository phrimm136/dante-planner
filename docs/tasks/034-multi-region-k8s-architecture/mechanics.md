...
- FE surface: `useAppSse.ts` (7 invalidations → payload patches), `usePlannerCommentsSse.ts`. Client reconnect jitter 0–5s on top of `retry:`; heartbeat < 100s (Cloudflare idle limit).
