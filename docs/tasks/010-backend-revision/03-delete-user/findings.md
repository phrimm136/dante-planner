...
- 29+ tests written systematically because edge cases were explicitly in requirements.md
...
- Edge case testing list in requirements.md was gold for catching real implementation gaps
