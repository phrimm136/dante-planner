...
This is the planner decomposition that `docs/26-fe-entities-migration/` explicitly
...
- `docs/26-fe-entities-migration/{instructions,plan}.md` — SSOT + commit-discipline precedent.
