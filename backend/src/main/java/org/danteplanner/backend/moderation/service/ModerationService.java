...
public class ModerationService {
     ...
     */
    @Transactional(readOnly = true)
    public List<org.danteplanner.backend.moderation.dto.ModerationActionDto> getModerationActionsWithActors() {
        ...
        return actions.stream()
                .map(action -> {
                    ...
                    return org.danteplanner.backend.moderation.dto.ModerationActionDto.fromEntity(action, epithet, suffix);
                })
                .toList();
    }
