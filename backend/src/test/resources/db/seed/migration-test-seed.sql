...
-- ============================================================================
-- planner_stats — cutover counter store, consistent with the legacy columns
-- ============================================================================

INSERT IGNORE INTO planner_stats (planner_id, view_count, upvotes)
VALUES
    (UNHEX('AAAA0001000000000000000000000001'), 42, 5),
    (UNHEX('AAAA0002000000000000000000000002'), 18, 3),
    (UNHEX('AAAA0003000000000000000000000003'), 87, 12),
    (UNHEX('AAAA0004000000000000000000000004'), 0, 0);
