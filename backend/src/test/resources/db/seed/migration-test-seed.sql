...
--
-- Schema version: V038 (last migration reflected in seed values)
--
-- Coverage:
--   - selected_keywords: all 28 SET members across 4 planners
...
VALUES (
    ...
    'Assemble,KnowledgeExplored,AaCePcBt,SwordPlayOfTheHomeland,EchoOfMansion,TimeSuspend,EmergencyChargeForceField,BloodDinner,BlackCloud,RetaliationBook,HeishouSynergy,Bullet',
    87, NOW(6)
);
