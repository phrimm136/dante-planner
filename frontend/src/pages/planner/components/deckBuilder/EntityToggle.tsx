...
export const EntityToggle = memo(
  function EntityToggle({ mode, onModeChange }: EntityToggleProps) {
    ...
    return (
      <div className="flex gap-1 p-1 bg-card border border-border rounded-md">
        <Button
          variant="ghost"
          size="sm"
          className={cn('transition-colors', mode === 'identity' && 'bg-background shadow-sm')}
          onClick={() => {
            onModeChange('identity')
          }}
        >
        ...
        <Button
          variant="ghost"
          size="sm"
          className={cn('transition-colors', mode === 'ego' && 'bg-background shadow-sm')}
          onClick={() => {
            onModeChange('ego')
          }}
        >
