...
interface StartBuffCardVariant {
  root: string
  pane: string
  costAnchor: string
  costText: string
...
const CARD_VARIANTS: Record<number, StartBuffCardVariant> = {
  6: {
    root: 'w-68 h-80',
  ...
  7: {
    ...
    description: `flex-1 overflow-y-auto px-2 py-2 m-3 scrollbar-hide text-[${MD_ACCENT_COLORS[7]}] mt-10 mr-5`,
...
export function StartBuffCard({
  ...
  const version = mdVersion in CARD_VARIANTS ? mdVersion : FALLBACK_MD_VERSION
